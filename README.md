...
請求書・領収書のOCR読取結果と台帳データを照合し、消込候補や未一致データの確認を支援する業務改善ツールです。  
